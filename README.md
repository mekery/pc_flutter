 ...
 * `package:pc_flutter/pointycastle.dart`: exports the high-level API and the
    registry loaded with all available implementations
 * `package:pc_flutter/api.dart`: exports the high-level API and the registry
    without any implementations
 * `package:pc_flutter/export.dart`: exports the API and all implementation
    classes
